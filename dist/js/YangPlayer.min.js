...
"use strict";function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}();!function(){function e(e){return document.querySelector(e)}var t={playerPlayState:null},n=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"getBrowserInfo",value:function(){var e=navigator.userAgent,t=void 0,n=e.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(n[1])?(t=/\brv[ :]+(\d+)/g.exec(e)||[],{browser:"IE",version:t[1]||""}):"Chrome"===n[1]&&(t=e.match(/\b(OPR|Edge)\/(\d+)/))?{browser:"Opera",version:t.slice(1)[1]}:(n=n[2]?[n[1],n[2]]:[navigator.appName,navigator.appVersion,"-?"],(t=e.match(/version\/(\d+)/i))&&n.splice(1,1,t[1]),{browser:n[0],version:n[1]})}},{key:"isWhichBrowser",value:function(e){if(!e)throw new Error('param "browser" of method "isWhichBrowser" is not given!');var t=e.toLowerCase(),n=!!window.opr&&!!opr.addons||!!window.opera||navigator.userAgent.indexOf(" OPR/")>=0,o="undefined"!=typeof InstallTrigger,r=!!document.documentMode,i=!r&&!!window.StyleMedia,s=!!window.chrome&&!!window.chrome.webstore,l=/constructor/i.test(window.HTMLElement)||function(e){return"[object SafariRemoteNotification]"===e.toString()}(!window.safari||safari.pushNotification)||Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")>0||!s&&!n&&void 0!==window.webkitAudioContext,a={opera:n,firefox:o,safari:l,ie:r,edge:i,chrome:s};return a[t]}},{key:"addClass",value:function(e,t){if(!t)throw new Error('second param "element" of method "addClass" is not given!');var n=t.className;t.className=n+" "+e}},{key:"removeClass",value:function(e,t){if(!t)throw new Error('second param "element" of method "removeClass" is not given!');var n=t.className;n.includes(e)&&(t.className=n.slice(0,n.indexOf(""+e)-1))}},{key:"offset",value:function(e,t){if(!t)throw new Error('second param "element" of method "offset" is not given!');var n=e.left,o=e.top,r=t.parentNode;r.style.position=window.getComputedStyle(r).position||"relative",t.style.position="absolute",t.style.left=n+"px",t.style.top=o+"px"}},{key:"outerWidth",value:function(e){if(!e)throw new Error('param "element" of method "outerWidth" is not given!');return e.offsetWidth}},{key:"outerHeight",value:function(e){if(!e)throw new Error('param "element" of method "outerHeight" is not given!');return e.offsetHeight}},{key:"getOffsetLeft",value:function(e){if(!e)throw new Error('param "element" of method "getOffsetLeft" is not given!');return e.offsetLeft}},{key:"getOffsetTop",value:function(e){if(!e)throw new Error('param "element" of method "getOffsetTop" is not given!');return e.offsetTop}},{key:"getPageX",value:function(e){if(!e)throw new Error('param "element" of method "getPageX" is not given!');var t=window.pageXOffset,n=e.getBoundingClientRect().left,o=t+n;return o}},{key:"getPageY",value:function(e){if(!e)throw new Error('param "element" of method "getPageY" is not given!');var t=window.pageYOffset,n=e.getBoundingClientRect().top,o=t+n;return o}}]),e}(),o=function(){function e(t){_classCallCheck(this,e),this.classObject=t}return _createClass(e,[{key:"buttonWasClicked",value:function(){throw new Error('method "buttonWasClicked" of super class must be overrided!')}}]),e}(),r=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(){this.classObject.pauseVideo()}}]),t}(o),i=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(){this.classObject.pauseVideo()}}]),t}(o),s=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(){this.classObject.playVideo()}}]),t}(o),l=function(t){function n(t){_classCallCheck(this,n);var o={abort:1,network:2,decode:3,support:4},r={network:"哎呀，网络好像出错了！\n刷新网页试一下:P",decode:"咦，视频解码错误，\n这一定不是我的锅，\n换其他视频看看:）",support:"天啦噜，视频不存在或者当前的浏览器不支持这个格式的视频:(，\n换其他视频看看"},i=_possibleConstructorReturn(this,(n.__proto__||Object.getPrototypeOf(n)).call(this,t));return i.mediaErrorCode=o,i.errorMessage=r,i.errDisplay=e(".YangPlayer-error-prompt"),i}return _inherits(n,t),_createClass(n,[{key:"buttonWasClicked",value:function(e,t){this.displayErrorMsg(e,t)}},{key:"displayErrorMsg",value:function(e,t){this.errDisplay.style.display="block",this.classObject.forbidEventBinding();for(var n in this.mediaErrorCode)this.mediaErrorCode[n]===e&&(this.errDisplay.innerHTML=this.errorMessage[n],window.clearInterval(t))}}]),n}(o),a=function(){function t(n){_classCallCheck(this,t);var o={empty:0,idle:1,loading:2,source:3};this.classObject=n,this.networkStateCode=o,this.errDisplay=e(".YangPlayer-error-prompt")}return _createClass(t,[{key:"sourceState",value:function(e,t){if(3===e){var n="哎呀，这个视频地址的资源好像不见了！\n刷新网页或者换其他视频看看";this.errDisplay.style.display="block",this.classObject.forbidEventBinding(),this.classObject.setErrorSign(),this.errDisplay.innerHTML=n,window.clearInterval(t)}}}]),t}(),u=function(){function e(t){_classCallCheck(this,e);var n={nothing:0,metadata:1,current:2,future:3,enough:4};this.classObject=t,this.readyStateCode=n}return _createClass(e,[{key:"toggleLoadingSign",value:function(e){return e<3?void this.classObject.setLoadingSign():void(e>=3&&this.classObject.playVideo())}}]),e}(),c=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(){this.classObject.muteVolume()}}]),t}(o),h=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(){this.classObject.normalVolume()}}]),t}(o),y=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(e){if(e){if("loop"===e)return void this.classObject.loopPlayOff();if("auto"===e)return void this.classObject.autoPlayOff();throw new Error('param "btnType" of method "buttonWasClicked" is incorrect!')}throw new Error('param "btnType" of method "buttonWasClicked" is not given!')}}]),t}(o),p=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"buttonWasClicked",value:function(e){if(e){if("loop"===e)return void this.classObject.loopPlayOn();if("auto"===e)return void this.classObject.autoPlayOn();throw new Error('param "btnType" of method "buttonWasClicked" is incorrect!')}throw new Error('param "btnType" of method "buttonWasClicked" is not given!')}}]),t}(o),f=function(){function n(o){_classCallCheck(this,n),this.loadingState=new r(this),this.playingState=new i(this),this.pausingState=new s(this),this.playErrorState=new l(this),this.player=o,this.playButton=e(".YangPlayer-play-button"),this.pauseButton=e(".YangPlayer-pause-button"),this.playCircle=e(".YangPlayer-play-circle"),this.playLoading=e(".YangPlayer-loading"),this.controlPlayButton=e(".YangPlayer-controlPlay-button"),this.replayButton=e(".YangPlayer-replay"),this.playerState=t.playerPlayState,this.readyState=new u(this),this.networkState=new a(this)}return _createClass(n,[{key:"init",value:function(){var e=this;this.player.oncanplaythrough=function(){e.setPausingSign(),e.controlPlayButton.onclick=function(){e.playerState.buttonWasClicked()},e.player.onclick=function(){e.playerState.buttonWasClicked()},e.playCircle.onclick=function(){e.playerState.buttonWasClicked()},document.onkeydown=function(t){var n=t.key||t.keyCode;" "!==n&&32!==n||e.playerState.buttonWasClicked()},e.player.oncanplaythrough=null}}},{key:"listenError",value:function(e){if(this.player.error){var t=this.player.error.code;if(1===t)return;this.setErrorSign(),this.playerState.buttonWasClicked(t,e)}}},{key:"listenReadyState",value:function(){if(!this.player.paused){var e=this.player.readyState;this.readyState.toggleLoadingSign(e)}}},{key:"listenNetwork",value:function(e){var t=this.player.networkState;this.networkState.sourceState(t,e)}},{key:"listenAll",value:function(e){this.listenReadyState(),this.listenError(e),this.listenNetwork(e)}},{key:"forbidEventBinding",value:function(){this.controlPlayButton.onclick=null,this.player.onclick=null,this.playCircle.onclick=null,document.onkeydown=null}},{key:"setErrorSign",value:function(){this.playLoading.style.display="none",this.player.style.opacity=0,this.playCircle.style.display="none",this.pauseButton.style.display="none",this.playButton.style.display="inline-block",this.setState(this.playErrorState)}},{key:"setLoadingSign",value:function(){this.playLoading.style.display="block",this.player.style.opacity=.5,this.playCircle.style.display="none",this.pauseButton.style.display="inline-block",this.playButton.style.display="none",this.setState(this.loadingState)}},{key:"setPausingSign",value:function(){this.playLoading.style.display="none",this.player.style.opacity=.5,this.playCircle.style.display="block",this.pauseButton.style.display="none",this.playButton.style.display="inline-block",this.setState(this.pausingState)}},{key:"setPlayingSign",value:function(){this.playLoading.style.display="none",this.replayButton.style.display="none",this.playButton.style.display="none",this.pauseButton.style.display="inline-block",this.player.style.opacity=1,this.playCircle.style.display="none",this.setState(this.playingState)}},{key:"setReplayPausingSign",value:function(){this.playLoading.style.display="none",this.player.style.opacity=.5,this.playCircle.style.display="none",this.replayButton.style.display="block",this.playButton.style.display="inline-block",this.pauseButton.style.display="none",this.setState(this.pausingState)}},{key:"replayVideo",value:function(e){e.progressDragButton.style.left=0,e.progressPlayedbarDisplay(),this.playVideo()}},{key:"setReplayEventBinding",value:function(e){var t=this;this.setReplayPausingSign(),this.controlPlayButton.onclick=function(){t.replayVideo(e),t.restoreDefaultBinding()},this.replayButton.onclick=function(){t.replayVideo(e),t.restoreDefaultBinding()},this.player.onclick=function(){t.replayVideo(e),t.restoreDefaultBinding()},document.onkeydown=function(n){var o=n.key||n.keyCode;" "!==o&&32!==o||(t.replayVideo(e),t.restoreDefaultBinding())}}},{key:"restoreDefaultBinding",value:function(){var e=this;this.controlPlayButton.onclick=function(){e.playerState.buttonWasClicked()},this.replayButton.onclick=null,this.player.onclick=function(){e.playerState.buttonWasClicked()},document.onkeydown=function(t){var n=t.key||t.keyCode;" "!==n&&32!==n||e.playerState.buttonWasClicked()}}},{key:"playVideo",value:function(){var e="AbortError: The play() request was interrupted by a call to pause().";this.setPlayingSign();var t=this.player.play();t.catch(function(t){return t.toString()===e?void console.log("Abort `play` promise."):void console.log(t)})}},{key:"pauseVideo",value:function(){this.setPausingSign(),this.player.pause()}},{key:"setState",value:function(e){t.playerPlayState=e,this.playerState=e}}]),n}(),d=function(){function t(n){_classCallCheck(this,t);var o=50,r=.5,i=28,s=56;this.normalVolumeState=new c(this),this.muteVolumeState=new h(this),this.player=n,this.volumeButton=e(".YangPlayer-volume-button"),this.volumeUpButton=e(".YangPlayer-volume-up"),this.volumeDownButton=e(".YangPlayer-volume-down"),this.volumeOffButton=e(".YangPlayer-volume-off"),this.volumeChangeRect=e(".YangPlayer-volume-change"),this.volumeNumber=e(".YangPlayer-volume-number"),this.midVolumeBarH=i,this.volumeNumberValue=o,this.realVolumeValue=r,this.volumeBar=e(".YangPlayer-volume-bar"),this.volumeDragButton=e(".YangPlayer-volume-dragButton"),this.currentVolumeReverseBar=e(".YangPlayer-currentVolume-reverseBar"),this.currentVolumeBarH=i,this.mouseYMax=s,this.volumeState=null,this.mousedownFired=!1}return _createClass(t,[{key:"init",value:function(){var e=this;this.setState(this.normalVolumeState),this.displayVolumeButton(),this.normalVolume(),this.controlVolumeButton(),this.volumeButton.onclick=function(){return e.mousedownFired?void(e.mousedownFired=!1):void e.volumeState.buttonWasClicked()},this.volumeChangeRect.onclick=function(){e.mousedownFired=!0}}},{key:"controlVolumeButton",value:function(t){var o=this,r=Number.parseInt(window.getComputedStyle(this.volumeDragButton).left);return t?(n.offset({top:t,left:r},this.volumeDragButton),void(this.currentVolumeReverseBar.style.height=n.getOffsetTop(this.volumeDragButton)/n.outerHeight(this.volumeBar)*100+"%")):void(this.volumeDragButton.onmousedown=function(t){o.mousedownFired=!0,n.addClass("draggable",o.volumeDragButton),o.volumeDragButton.onmousemove=function(t){var i=t.pageY-n.outerHeight(o.volumeDragButton)/2-n.getPageY(o.volumeBar),s=i<=0?0:i>=o.mouseYMax?o.mouseYMax:i;n.offset({top:s,left:r},e(".draggable")),o.currentVolumeReverseBar.style.height=n.getOffsetTop(o.volumeDragButton)/n.outerHeight(o.volumeBar)*100+"%",o.currentVolumeBarH=n.outerHeight(o.volumeBar)-s-n.outerHeight(o.volumeDragButton),o.changeVolume(o.currentVolumeBarH),t.preventDefault()},o.volumeDragButton.onmouseup=function(e){n.removeClass("draggable",o.volumeDragButton),o.volumeDragButton.onmousemove=null,e.preventDefault()},o.volumeDragButton.onmouseout=function(e){n.removeClass("draggable",o.volumeDragButton),o.volumeDragButton.onmousemove=null,e.preventDefault()},t.preventDefault()})}},{key:"changeVolume",value:function(e){this.volumeNumberValue=Number.parseInt(e/this.mouseYMax*100),this.realVolumeValue=(e/this.mouseYMax).toFixed(2),this.volumeNumber.innerHTML=this.volumeNumberValue,this.player.volume=this.realVolumeValue}},{key:"displayVolumeButton",value:function(e){var t=this;if(e){if("normal"===e)return void this.displayWhichVolumeBtn("up");if("mute"===e)return void this.displayWhichVolumeBtn("off")}this.volumeButton.onmouseover=function(){t.volumeChangeRect.style.opacity=1,t.volumeChangeRect.style.visibility="visible",t.volumeButton.style.backgroundColor="#ccc",t.volumeChangeRect.onmousemove=function(){return 0===t.volumeNumberValue?void t.displayWhichVolumeBtn("off"):t.volumeNumberValue>0&&t.volumeNumberValue<50?void t.displayWhichVolumeBtn("down"):void t.displayWhichVolumeBtn("up")}},this.volumeButton.onmouseout=function(){t.volumeChangeRect.style.opacity=0,t.volumeChangeRect.style.visibility="hidden",t.volumeButton.style.backgroundColor="#eee"}}},{key:"displayWhichVolumeBtn",value:function(e){this.volumeDownButton.style.display="none",this.volumeUpButton.style.display="none",this.volumeOffButton.style.display="none","down"===e?this.volumeDownButton.style.display="inline-block":"up"===e?this.volumeUpButton.style.display="inline-block":"off"===e&&(this.volumeOffButton.style.display="inline-block")}},{key:"normalVolume",value:function(){this.changeVolume(this.midVolumeBarH),this.controlVolumeButton(this.midVolumeBarH),this.displayVolumeButton("normal"),this.setState(this.normalVolumeState)}},{key:"muteVolume",value:function(){this.changeVolume(0),this.controlVolumeButton(this.mouseYMax),this.displayVolumeButton("mute"),this.setState(this.muteVolumeState)}},{key:"setState",value:function(e){this.volumeState=e}}]),t}(),g=function(){function t(o){var r=this;_classCallCheck(this,t),this.player=o,this.intervalId=null,this.intervalFunc=null,this.progressBar=e(".YangPlayer-progress"),this.progressPlayedbar=e(".YangPlayer-playedbar"),this.progressBufferedbar=e(".YangPlayer-bufferedbar"),this.playedTime=e(".YangPlayer-played-time"),this.totalTime=e(".YangPlayer-total-time"),this.progressDragButton=e(".YangPlayer-progress-dragButton"),this.mouseXMax=function(){return n.outerWidth(r.progressBar)-n.outerWidth(r.progressDragButton)}}return _createClass(t,[{key:"init",value:function(){t.setProgressLength(),this.progressPlayedbarDisplay(),this.controlProgressButton()}},{key:"controlProgressButton",value:function(t,o){var r=this,i=Number.parseInt(window.getComputedStyle(this.progressDragButton).top),s=o;return t?(n.offset({top:i,left:t},this.progressDragButton),void(this.progressPlayedbar.style.width=n.getOffsetLeft(this.progressDragButton)/n.outerWidth(this.progressBar)*100+"%")):void(this.progressDragButton.onmousedown=function(t){n.addClass("draggable",r.progressDragButton),r.progressDragButton.onmousemove=function(t){var o=t.pageX-n.outerWidth(r.progressDragButton)/2-n.getPageX(r.progressBar),l=o<=0?0:o>=r.mouseXMax()?r.mouseXMax():o;n.offset({top:i,left:l},e(".draggable")),r.progressPlayedbar.style.width=n.getOffsetLeft(r.progressDragButton)/n.outerWidth(r.progressBar)*100+"%",r.player.paused&&(s.playVideo(),r.intervalId=window.setInterval(r.intervalFunc,1e3)),r.player.currentTime=n.getOffsetLeft(r.progressDragButton)*r.player.duration/r.mouseXMax(),t.preventDefault()},r.progressDragButton.onmouseup=function(e){n.removeClass("draggable",r.progressDragButton),r.progressDragButton.onmousemove=null,e.preventDefault()},r.progressDragButton.onmouseout=function(e){n.removeClass("draggable",r.progressDragButton),r.progressDragButton.onmousemove=null,e.preventDefault()},t.preventDefault()})}},{key:"progressPlayedbarDisplay",value:function(){var e=this;this.player.currentTime=0,this.progressPlayedbar.style.width=0,this.progressBufferedbar.style.width=0;var t=new f(this.player);this.intervalFunc=function(){if(e.player.duration>0){var n=Math.floor(e.player.currentTime/e.player.duration*100)+"%",o=e.player.currentTime*e.mouseXMax()/e.player.duration;e.progressPlayedbar.style.display="block",e.progressPlayedbar.style.width=n,e.progressTimeDisplay(e.player.currentTime,e.player.duration),e.controlProgressButton(o,t)}t.listenAll(e.intervalId),e.player.ended&&(t.setReplayEventBinding(e),window.clearInterval(e.intervalId)),e.progressBufferedDisplay()},this.intervalId=window.setInterval(this.intervalFunc,1e3)}},{key:"progressBufferedDisplay",value:function(){if(this.player.buffered.length>0){var e=Math.floor(this.player.buffered.end(0)/this.player.duration*100)+"%";this.progressBufferedbar.style.display="block",this.progressBufferedbar.style.width=e}}},{key:"progressTimeDisplay",value:function(e,t){var n=void 0,o=void 0,r=void 0,i=void 0,s=void 0,l=void 0,a=(i=Math.floor(e/3600))<10?"0"+i:i,u=(s=Math.floor(e%3600/60))<10?"0"+s:s,c=(l=Math.floor(e%3600%60))<10?"0"+l:l,h=(n=Math.floor(t/3600))<10?"0"+n:n,y=(o=Math.floor(t%3600/60))<10?"0"+o:o,p=(r=Math.floor(t%3600%60))<10?"0"+r:r;this.playedTime.innerHTML=a+":"+u+":"+c,this.totalTime.innerHTML=h+":"+y+":"+p}}],[{key:"setProgressLength",value:function(){var t=n.isWhichBrowser("Safari")&&document.webkitIsFullScreen?window.innerWidth:n.outerWidth(e("#YangPlayer")),o=n.outerWidth(e(".YangPlayer-controlPlay-button")),r=n.outerWidth(e(".YangPlayer-time")),i=n.outerWidth(e(".YangPlayer-volume-button")),s=n.outerWidth(e(".YangPlayer-screen-mode")),l=n.outerWidth(e(".YangPlayer-setting-button")),a=t-o-r-i-s-l-30;e(".YangPlayer-progress").style.width=a/t*100+"%"}}]),t}(),m=function(){function t(n){_classCallCheck(this,t);var o=[.5,1,1.5,2,4];this.switchOnState=new y(this),this.switchOffState=new p(this),this.player=n,this.settingBtn=e(".YangPlayer-setting-button"),this.settingPane=e(".YangPlayer-setting-pane"),this.loopSwitch=e(".YangPlayer-loop-switch"),this.loopSwitchOn=e(".YangPlayer-loop-on"),this.loopSwitchOff=e(".YangPlayer-loop-off"),this.autoSwitch=e(".YangPlayer-auto-switch"),this.autoSwitchOn=e(".YangPlayer-auto-on"),this.autoSwitchOff=e(".YangPlayer-auto-off"),this.rateBtn=e(".YangPlayer-rate-btn"),this.rate=o,this.loopState=null,this.autoState=null}return _createClass(t,[{key:"init",value:function(){var e=this;this.setSwitchState(this.switchOffState,"loop"),this.setSwitchState(this.switchOffState,"auto"),this.displaySettingBtn(),this.loopSwitch.onclick=function(){e.loopState.buttonWasClicked("loop")},this.autoSwitch.onclick=function(){e.autoState.buttonWasClicked("auto")},this.controlPlayRate()}},{key:"displaySettingBtn",value:function(){var e=this;this.settingBtn.onmouseover=function(){e.settingPane.style.opacity=1,e.settingPane.style.visibility="visible",e.settingBtn.style.backgroundColor="#ccc"},this.settingBtn.onmouseout=function(){e.settingPane.style.opacity=0,e.settingPane.style.visibility="hidden",e.settingBtn.style.backgroundColor="#eee"}}},{key:"controlPlayRate",value:function(){for(var e=this,t=function(t){e.rateBtn.children[t].onclick=function(){for(var n=0;n<e.rateBtn.children.length;n++)e.rateBtn.children[n].style.opacity=.4;e.rateBtn.children[t].style.opacity=1,e.setPlayRate(e.rate[t])}},n=0;n<this.rateBtn.children.length;n++)t(n)}},{key:"loopPlayOn",value:function(){this.loopSwitchOff.style.display="none",this.loopSwitchOn.style.display="inline-block",this.player.loop=!0,this.setSwitchState(this.switchOnState,"loop")}},{key:"loopPlayOff",value:function(){this.loopSwitchOff.style.display="inline-block",this.loopSwitchOn.style.display="none",this.player.loop=!1,this.setSwitchState(this.switchOffState,"loop")}},{key:"autoPlayOn",value:function(){if(this.autoSwitchOff.style.display="none",this.autoSwitchOn.style.display="inline-block",this.player.autoplay=!0,this.setSwitchState(this.switchOnState,"auto"),this.player.paused){var e=new f(this.player);e.playVideo()}}},{key:"autoPlayOff",value:function(){this.autoSwitchOff.style.display="inline-block",this.autoSwitchOn.style.display="none",this.player.autoplay=!1,this.setSwitchState(this.switchOffState,"auto")}},{key:"setPlayRate",value:function(e){this.player.playbackRate=e}},{key:"setSwitchState",value:function(e,t){if(t){if("loop"===t)return void(this.loopState=e);if("auto"===t)return void(this.autoState=e);throw new Error('second param "switchType" of method "setSwitchState" is incorrect!')}throw new Error('second param "switchType" of method "setSwitchState" is not given!')}}]),t}(),v=function(){function t(n){_classCallCheck(this,t),this.player=n,this.playerContainer=e(".YangPlayer-container"),this.controlBar=e(".YangPlayer-control"),this.controlBarBox=e(".YangPlayer-control-box"),this.screenModeButton=e(".YangPlayer-screen-mode"),this.fullscreenButton=e(".YangPlayer-fullscreen"),this.minscreenButton=e(".YangPlayer-minscreen"),this.fullscreenElement=null,this.isFullscreen=!1,this.fullscreenEnabled=!1}return _createClass(t,[{key:"init",value:function(){var e=this;if(t.getBrowserSupportObj())return this.fullscreenElement=function(){return document[t.getBrowserSupportObj().fullscreenElement]},this.isFullscreen=function(){return Boolean(e.fullscreenElement())},this.fullscreenEnabled=function(){return document[t.getBrowserSupportObj().fullscreenEnabled]},void(this.screenModeButton.onclick=function(){var t=document.mozCancelFullScreen?e.playerContainer:e.player;e.toggle(t),e.onfullscreenchange(g.setProgressLength),window.onresize=g.setProgressLength});throw new Error("Current browser doesn't support Fullscreen API!")}},{key:"onfullscreenchange",value:function(e){var n=this;if(t.getBrowserSupportObj()){var o=t.getBrowserSupportObj().onfullscreenchange,r=function(){e(),n.notOverControlBar()};return document[o]=r}throw new Error("Current browser doesn't support Fullscreen API!")}},{key:"notOverControlBar",value:function(){var e=this;this.isFullscreen()?(this.fullscreenButton.style.display="none",this.minscreenButton.style.display="inline-block",this.controlBar.style.transition="all 0.5s linear",this.controlBar.onmouseleave=function(){e.controlBar.style.opacity=0,e.controlBar.style.visibility="hidden"},this.controlBarBox.onmouseenter=function(){e.controlBar.style.opacity=1,e.controlBar.style.visibility="visible"}):(this.fullscreenButton.style.display="inline-block",this.minscreenButton.style.display="none",this.controlBarBox.onmouseenter=null,this.controlBar.onmouseleave=null,this.controlBar.style.transition="none",this.controlBar.style.opacity=1,this.controlBar.style.visibility="visible")}},{key:"requestFullscreen",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document.documentElement;if(t.getBrowserSupportObj()){var n=t.getBrowserSupportObj().requestFullscreen;return this.fullscreenButton.style.display="none",this.minscreenButton.style.display="inline-block",e[n]()}throw new Error("Current browser doesn't support Fullscreen API!")}},{key:"exitFullscreen",value:function(){if(t.getBrowserSupportObj()){var e=t.getBrowserSupportObj().exitFullscreen;return this.fullscreenButton.style.display="inline-block",this.minscreenButton.style.display="none",document[e]()}throw new Error("Current browser doesn't support Fullscreen API!")}},{key:"toggle",value:function(e){return this.isFullscreen()?this.exitFullscreen():this.requestFullscreen(e)}}],[{key:"getBrowserSupportObj",value:function(){for(var e=[["requestFullscreen","exitFullscreen","onfullscreenerror","onfullscreenchange","fullscreenElement","fullscreenEnabled","fullscreen"],["webkitRequestFullscreen","webkitExitFullscreen","onwebkitfullscreenerror","onwebkitfullscreenchange","webkitFullscreenElement","webkitFullscreenEnabled","webkitIsFullScreen"],["mozRequestFullScreen","mozCancelFullScreen","onmozfullscreenerror","onmozfullscreenchange","mozFullScreenElement","mozFullScreenEnabled","mozFullScreen"],["msRequestFullscreen","msExitFullscreen","onmsfullscreenerror","onmsfullscreenchange","msFullscreenElement","msFullscreenEnabled",null]],t={},n=0;n<e.length;n++){var o=e[n];if(o[1]in document){for(var r=0;r<o.length;r++)t[e[0][r]]=o[r];return t}}return!1}}]),t}(),b=(function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"init",value:function(){}}]),e}(),function(){function t(){_classCallCheck(this,t),this.YangPlayer=e("#YangPlayer"),this.controlPlay=null,this.progressBar=null,this.volumeButton=null,this.settingButton=null,this.screenMode=null}return _createClass(t,[{key:"init",value:function(){this.controlPlay=new f(this.YangPlayer),this.controlPlay.init(),this.progressBar=new g(this.YangPlayer),this.progressBar.init(),this.volumeButton=new d(this.YangPlayer),this.volumeButton.init(),this.settingButton=new m(this.YangPlayer),this.settingButton.init(),this.screenMode=new v(this.YangPlayer),this.screenMode.init()}}]),t}()),w=new b;w.init()}();